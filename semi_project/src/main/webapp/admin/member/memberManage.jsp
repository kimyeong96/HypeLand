		...
		<div class="row adminSidebar adminContent d-flex">
			...
			<div class="col-md-10 adminMainContainer">
				<div class="table firstTable">
					<h2 class="text-center mt-5 firstTableTitle">회원 조회</h2>
					...
					<ul class="pagination justify-content-center">
						<c:if test="${naviMap.Prev eq true}">
							<li class="page-item"><a class="page-link"
								href="/select.amem?curPage=${naviMap.startNavi-1}"
						...
						<c:if test="${naviMap.Next eq true}">
							<li class="page-item"><a class="page-link"
								href="/select.amem?curPage=${naviMap.endNavi+1}"
       ...
       $(".adminIconLogout").on("click",function(){
		...
		$("#searchBtn").on("click",	function() {
			...
			if (searchWord == "") {
				...
				location.href = "/search.amem?&curPage=1&&searchWord="+ searchWord;
			}
		})
		// 페이지네이션 action
