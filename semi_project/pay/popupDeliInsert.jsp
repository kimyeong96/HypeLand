...
function insert(){
 let insert_phone =$("#deli_phone1 option:selected").val() +"-"+ $("#deli_phone2").val() +"-"+ $("#deli_phone3").val();
 
 opener.$("input:checkbox[name='destination']").attr("checked", false); 
 
 opener.$("#order_address").text($("#deli_roadAddr").val() + $("#deli_detailAddr").val());
 opener.$("#order_phone").text(insert_phone);
 opener.$("#order_name").text($("#deli_name").val()); 
 opener.$("#order_postCode").val($("#deli_postCode").val()); 
}
