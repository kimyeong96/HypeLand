  ...
  <div class="container" style="border: 1px solid lightgray; margin-top: 150px;">
    <div class="row">
      <div class="col header-comment">
        <h3 style="display: inline-block;">Order Completed</h3>
        <span class="comment">주문 완료</span>
      </div>
    </div>        
    <div class="row" style="text-align: center; border: none;">
        <div class="col" style="text-align: center; border: none; margin-top: 40px;">
            <h4>감사합니다. 주문이 완료되었습니다.</h4>
            <button type="button" class="btn btn-dark btnHome" style="margin: 30px; width: 100px; height: 30%;"><p>홈으로</p></button>
        </div>
    </div>
