				...
				<div class="table firstTable">
									...
									<c:otherwise>
										<c:forEach items="${list}" var="dto">
											<tr>
												...
												<td>
													<a href="#"><i class="fa-solid fa-magnifying-glass reviewDetailIcon"></i></a>
												</td>
												<td>
													<a href="#"><i class="fa-solid fa-trash reviewDeleteIcon"></i></a>
												</td>
												<td>
													<input type="text" value="${dto.seq_review}" class="reviewDetailInput d-none">
												</td>
											</tr>
										</c:forEach>
									</c:otherwise>
					...
					<div class="reviewDetailModal">
						<div class="reviewModalBox">
							...
							<div class="row reviewDetailModalImg d-flex justify-content-center ">
								<div class="col reviewDetailImg "></div>
							</div>
							<div class="row reviewDetailModalText d-flex justify-content-center ">
