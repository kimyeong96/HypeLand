			...
			<div class="adminContainer">
				...
				<div class="row adminNavbar d-flex align-items-center">
					...
					<div class="col-md-10 adminNavbar-right d-flex justify-content-end">
						<div class="adminIcon">
							<span class="adminIconSpan">Admin</span> <i class="fa-solid fa-user-check"></i> <span
								class="adminIconLogout">로그아웃</span>
						</div>
					</div>
				</div>
				...
				<div class="row adminSidebar adminContent d-flex">
					...
					<div class="col-md-10 adminMainContainer">
						<div class="table firstTable">
							...
							<!-- 문의 고르기 -->
							<div class="boardCategory d-flex justify-content-center mt-4" style="border-top-width: 0px">
							...
							<div class="selectAll ms-4" style="border-top-width: 0px">
								<i class="fa-solid fa-folder-open"></i> <span class="ms-2 selectAllIcon">전체조회</span>
							</div>
											...
											<c:otherwise>
												<c:forEach items="${list}" var="dto">
													<tr>
														...
														<td>
															<a href="/boardQnaRegister.qna?seq_qna=${dto.seq_qna}">
								...
								<ul class="pagination justify-content-center">
									<c:if test="${naviMap.needPrev eq true}">
										<li class="page-item"><a class="page-link pageBtn1"
												href="/selectedProc.qna?curPage=${naviMap.startNavi-1}&selectedVal=${list[0].getQna_type()}">Prev</a>
										</li>
									</c:if>
									<c:forEach var="pageNum" begin="${naviMap.startNavi}" end="${naviMap.endNavi}" step="1">
										<li class="page-item"><a class="page-link pageActive${pageNum}"
												href="/selectedProc.qna?curPage=${pageNum}&selectedVal=${list[0].getQna_type()}">${pageNum}</a>
										</li>
									</c:forEach>
									<c:if test="${naviMap.needNext eq true}">
										<li class="page-item"><a class="page-link pageBtn3"
												href="/selectedProc.qna?curPage=${naviMap.endNavi+1}&selectedVal=${list[0].getQna_type()}">Next</a>
										</li>
									</c:if>
								</ul>
							</nav>
...
<script>
	...
	$(document).ready(function () {
		$("#category-Selector").change(function () {
			...
			location.href = "/selectedProc.qna?curPage=1&selectedVal="+ selectedVal;
			});
	})
</script>
</body>
