...
<html>
  ...
  <body>
      ...
      <div class="row adminSidebar adminContent d-flex">
        ...
        <div class="col-md-10 adminMainContainer">
          <div class="table firstTable">
            <h2 class="text-center mt-5 firstTableTitle">배송 정보</h2>

            <!-- 배송 상태 고르기 -->
            <div class="boardCategory d-flex justify-content-center mt-4"
              style="border-top-width: 0px">
              <select class="form-select w-25" id="category-Selector">
                <option>배송 상태를 선택하세요</option>
                <option value="상품 준비중" class="productReady" name="productReady">
                  상품 준비중
                </option>
                <option value="상품 출발" class="productStart" name="productStart">
                  상품 출발
                </option>
                <option value="상품 도착" class="productArrive" name="productArrive">
                  상품 도착
                </option>
              </select>
            </div>
            ...
            <div class="selectAll ms-4" style="border-top-width: 0px">
              ...
              <span class="ms-1" id="selectAllIcon">전체조회</span>
            </div>
    ...
    <script>
      ...
      // select에서 선택된 해당 value를 이용해 페이지 이동(엔터키)
      function enterKey() {
        $("#searchIcon").click();
      }

      // select에서 선택된 해당 value를 이용해 페이지 이동 (클릭)
